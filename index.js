...
function getYtVideo(){
	...
	if(link.length == 28){
		...
		document.getElementById("myframe").src="https://www.youtube.com/embed/"+shortenLink+"?version=3&enablejsapi=1";
		ytlink = link;
	} else {
		alert("Invalid url!");
	}
	...
	if(sharedLink != null && link != null){
    		...
    		(() => {
    			...
    			const intervalId = setInterval(() => {
        			...
        			if (linkKey != null) {
            			var genLink = "file:///E:/programs/www.ytpromotion.com/sharable.html?"+linkKey;
